...
var compileEnvPrototypeV1 = map[string]interface{}{
	...
	requestRuleTraceFunction: func(string, bool) bool { return false },
...
func compileFromCacheByHash(exprStr, hash string) (*vm.Program, error) {
	...
	prog, err := expr.Compile(body, expr.Env(getCompileEnv(version)), expr.AsFloat64(), expr.Patch(requestRuleTracePatcher{}))
	if err != nil {
