...
func TestGetPreferredChannelByUserAgentRouting_AllowlistAndStrictPool(t *testing.T) {
	...
	require.False(t, PrepareUserAgentRoutingMode(allowlisted, "default"))
	require.False(t, common.GetContextKeyBool(allowlisted, constant.ContextKeyChannelAffinityUserAgentRouted))
	...
	require.True(t, PrepareUserAgentRoutingMode(unlisted, "default"))
