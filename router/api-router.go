	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/referral/members", controller.GetReferralMembers)
		...
		logRoute.GET("/ip-location", middleware.AdminAuth(), middleware.CriticalRateLimit(), controller.GetLogIPLocation)
		...
		dataRoute.DELETE("/performance-errors", middleware.AdminAuth(), middleware.CriticalRateLimit(), controller.ClearPerfMetricErrors)
