...
export type ModelSettings = {
  ...
  'user_agent_routing_setting.version_check_enabled': boolean
  'user_agent_routing_setting.minimum_versions': string
...
export type BillingSettings = {
  ...
  ReferralUsersPerTier: number
  ReferralMaxRate: number
  TopUpLink: string
...
export type OperationsSettings = {
  ...
  RequestIPLogEnabled: boolean
  UpstreamResponseModelLogEnabled: boolean
...
export type SecuritySettings = {
  ...
  BackgroundUserConcurrencyLimit: number
